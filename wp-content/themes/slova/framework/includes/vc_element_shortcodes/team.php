...
vc_map ( array (
		...
		"params" => array (
					...
					array(
						"type" => "checkbox",
						"class" => "",
						"heading" => __("Show Position", 'slova'),
						"param_name" => "show_position",
						"value" => array (
							__ ( "Yes, please", 'slova' ) => true
						),
						"group" => __("Template", 'slova'),
						"description" => __("Show or not position of post in this element.", 'slova')
					),
					array(
						"type" => "checkbox",
						"class" => "",
						"heading" => __("Show Social", 'slova'),
						"param_name" => "show_social",
						"value" => array (
							__ ( "Yes, please", 'slova' ) => true
						),
						"group" => __("Template", 'slova'),
						"description" => __("Show or not social of post in this element.", 'slova')
					),
					array(
						"type" => "checkbox",
						"class" => "",
					...
					array(
						"type" => "textfield",
						"class" => "",
						"heading" => __("Read More Text", 'slova'),
						"param_name" => "readmore_text",
						"value" => "",
						"group" => __("Template", 'slova'),
						"description" => __("Enter read more text of post in this element.", 'slova')
					),
		)
));