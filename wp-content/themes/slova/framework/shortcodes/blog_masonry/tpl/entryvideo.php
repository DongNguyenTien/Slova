<div class="ro-blog-item">
	<div class="ro-thumb">
		...
		<?php 
			$video_source = get_post_meta(get_the_ID(), 'tb_post_video_youtube', true);
			if($video_source) echo '<div class="ro-video"><a id="ro-play-button" class="fancybox fancybox.iframe" href="'.esc_url($video_source).'"><i class="fa fa-play"></i></a></div>';
		?>
	</div>
