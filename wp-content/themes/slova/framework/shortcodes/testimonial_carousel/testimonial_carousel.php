<?php
function ro_testimonial_carousel_func($atts, $content = null) {
    ...
    $class = array();
    $class[] = 'ro-testimonial-carousel-wrapper clearfix';
    $class[] = $el_class;
	...
	<div class="<?php echo esc_attr(implode(' ', $class)); ?>">
		<div class="ro-testimonial-carousel">
...
if(function_exists('insert_shortcode')) { insert_shortcode('testimonial_carousel', 'ro_testimonial_carousel_func'); }
